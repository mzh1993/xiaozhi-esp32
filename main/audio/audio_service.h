...
#define MAX_ENCODE_TASKS_IN_QUEUE 4   // 增加编码任务队列
#define MAX_PLAYBACK_TASKS_IN_QUEUE 4 // 增加播放任务队列
#define MAX_DECODE_PACKETS_IN_QUEUE (15000 / OPUS_FRAME_DURATION_MS)  // 增加到15秒缓冲区
#define MAX_SEND_PACKETS_IN_QUEUE (15000 / OPUS_FRAME_DURATION_MS)    // 增加到15秒缓冲区
